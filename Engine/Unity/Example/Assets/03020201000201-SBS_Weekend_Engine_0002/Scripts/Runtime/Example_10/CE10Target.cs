...
/** 타겟 */
public class CE10Target : CComponent
{
	/** 타겟 타입 */
	...
	/** 애니메이션 상태 종료를 처리한다 */
	private void HandleOnStateExit(CE10StateMachineBehaviour a_oSender,
	...
	private IEnumerator TryOpen()
	{
		...
		var oBehaviours = m_oAnimator.GetBehaviours<CE10StateMachineBehaviour>();
