...
/** NPC 상태 */
public class CE01NonPlayerState_18 : CState<CE01NonPlayer_18>
{
	#region 함수
	/** 상태가 시작되었을 경우 */
...
/** NPC 대기 상태 */
public class CE01NonPlayer_18IdleState : CE01NonPlayerState_18
{
	#region 함수
	/** 상태를 갱신한다 */
...
/** NPC 추적 상태 */
public class CE01NonPlayer_18TrackingState : CE01NonPlayerState_18
{
	#region 함수
	/** 상태가 시작되었을 경우 */
	public override void OnStateEnter()
...
/** NPC 전투 상태 */
public class CE01NonPlayer_18BattleState : CE01NonPlayerState_18
{
	#region 변수
	...
	public override void OnStateEnter()
	{
		...
		var oBehaviour = this.Owner.Animator.GetBehaviour<CE01AttackStateMachineBehaviour_18>();
...
/** NPC 죽음 상태 */
public class CE01NonPlayer_18DeathState : CE01NonPlayerState_18
{
	#region 함수
	/** 상태가 시작되었을 경우 */
	public override void OnStateEnter()
