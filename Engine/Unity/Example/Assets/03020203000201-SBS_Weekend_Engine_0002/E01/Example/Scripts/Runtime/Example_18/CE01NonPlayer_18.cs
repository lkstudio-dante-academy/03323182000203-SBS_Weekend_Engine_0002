...
/** NPC */
public class CE01NonPlayer_18 : CComponent
{
	#region 변수
	[Header("=====> Etc <=====")]
	...
	#region 프로퍼티
	public CStateMachine<CState<CE01NonPlayer_18>> StateMachine { get; } = new CStateMachine<CState<CE01NonPlayer_18>>();
	...
	public void OnHit(int a_nDamage,
		System.Action<CE01NonPlayer_18> a_oDeathCallback)
	{
		...
		if(m_nHP > 0)
		{
			...
			var oBehaviour = this.Animator.GetBehaviour<CE01HitStateMachineBehaviour_18>();
	...
	#region 팩토리 함수
	/** 대기 상태를 생성한다 */
	public CState<CE01NonPlayer_18> CreateIdleState()
	{
		return new CE01NonPlayer_18IdleState();
	}

	/** 추적 상태를 생성한다 */
	public CState<CE01NonPlayer_18> CreateTrackingState()
	{
		return new CE01NonPlayer_18TrackingState();
	}

	/** 전투 상태를 생성한다 */
	public CState<CE01NonPlayer_18> CreateBattleState()
	{
		return new CE01NonPlayer_18BattleState();
	}

	/** 죽음 상태를 생성한다 */
	public CState<CE01NonPlayer_18> CreateDeathState()
	{
		return new CE01NonPlayer_18DeathState();
	}
	#endregion // 팩토리 함수
}
