...
public partial class CE24NetworkManager : CSingleton<CE24NetworkManager> {
	...
	private void HandleResponse(CPacket a_oPacket) {
		switch(a_oPacket.PacketType) {
			case EPacketType.MATCHING: this.HandleResponseMatching(a_oPacket); break;
			case EPacketType.TOUCH_CELL: this.HandleResponseTouchCell(a_oPacket); break;
			case EPacketType.DISCONNECT: this.HandleResponseDisconnect(a_oPacket); break;
		}
	}
