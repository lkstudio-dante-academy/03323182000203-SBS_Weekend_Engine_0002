...
public class CE18Bullet : CComponent {
	...
	public record REParams {
		public Dictionary<CE18Player.EAbilityKinds, int> m_oAbilityValDict;
	}
	...
	#region 클래스 팩토리 함수
	/** 매개 변수를 생성한다 */
	public static REParams MakeParams(Dictionary<CE18Player.EAbilityKinds, int> a_oAbilityValDict) {
		return new REParams() {
